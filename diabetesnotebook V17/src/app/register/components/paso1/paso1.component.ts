...
import GeneradorAvatarComponent from '../../../shared/generador-avatar/generador-avatar.component';

@Component({
  selector: 'register-paso1',
  standalone: true,
  imports: [CommonModule, FormsModule, GeneradorAvatarComponent],
  templateUrl: './paso1.component.html',
  styleUrl: './paso1.component.css',
})
export default class Paso1Component {
